    ...
    <>
      <style jsx global>{`
        ...
        .animate-in .color-wheel {
          animation: colorWheel 60s infinite linear;
        }
      `}</style>
      ...
      <div className="flex md:items-end justify-center items-center mx-auto md:-mx-16 h-[650px]">
          ...
          <Phone className="z-5 hidden md:inline-block translate-x-3 hover:-translate-y-4" smallerHeight>
            <div
              ref={firstPhoneRef}
              className="w-full aspect-square bg-gradient-to-b from-[#F4F2D3] to-[#ADC5BB] border border-[#7b8942] rounded-3xl py-3 mb-6 flex flex-col justify-end pb-3 px-2 relative transition-all duration-500 hover:bg-[#526152] hover:shadow-lg"
            >
              <Image
