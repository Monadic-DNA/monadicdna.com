    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="px-6 md:pt-36 pt-24 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          {/* Launch Banner */}
          <div className="mb-4 md:mb-8 inline-flex items-center rounded-full bg-[#F6F4FF] py-2">
            <span className="mr-2" role="img" aria-label="rocket">🚀</span>
            <span className="text-[#8C66FF] md:text-base text-sm">Launching February 2025</span>
          </div>

          {/* Main Heading */}
          <h1 className="mb-6 sm:text-5xl text-4xl text-balance font-extrabold leading-tight tracking-tight ">
            DNA insights with privacy, autonomy, and boundless curiosity
          </h1>

          {/* Subheading */}
          <p className="mb-8 text-balance max-w-5xl sm:text-xl text-base leading-relaxed text-black">
          ...
          {/* Email Signup */}
          <div className="mb-12">
            <p className="mb-4 sm:text-base text-sm text-[#7E7E7E]">
            ...
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Input 
                ...
                className="max-w-sm h-12 placeholder:text-gray-500 text-base focus:ring-gray-300 rounded-none  border-black"
              />
              <Button 
                className="bg-black text-white hover:bg-black/90 md:text-lg text-base h-12 px-8 rounded-none"
              >
                Join the waitlist
              </Button>
            </div>
