...
export default function PhoneDisplay() {
  return (
    <div className="flex md:items-end justify-center items-center mx-auto md:-mx-16 h-[650px]">
      ...
      <div className="w-full aspect-square bg-gradient-to-b from- to-[#F4F2D3]to-[#ADC5BB] border border-black/50 rounded-3xl mb-6 flex flex-col justify-end pb-3 px-2">
          <div className="bg-gradient-to-b from-[#FFFFFF] to-[#FFFFF3] border border-[#7b8942] rounded-3xl py-3 px-1 mb-0">
        ...
        <div className="space-y-2 ">
          ...
          Find out which polarizing fruit your genetics suggest you'll love!  </p>
        </div>
      </Phone>

      <Phone className="z-10 md:inline-block hidden">
      <div className="w-full aspect-square bg-[#000040] border border-[#00001E] rounded-3xl mb-6 flex flex-col justify-end pb-3 px-2">
          <div className="bg-gradient-to-b from-[#FAFFFF] to-[#F7FFFF] border border-[#254668] rounded-3xl py-3 px-1 mb-0">
            <p className="text-center text-[#254668] font-unbounded font-semibold  text-[10px]">
            Are you more likely a sprinter or endurance runner?            </p>
          </div>
        </div>
        <div className="space-y-2 ">
          <h2 className="text-lg font-extrabold leading-tight">
          ...
          <p className="text-[11px] text-black">
          We'll periodically add interesting new insights and you can always use your DNA vault to get insights from other providers in the app too!                 </p>
        </div>
      </Phone>

      <Phone  className='-translate-x-3 z-5 md:inline-block hidden' smallerHeight>
        <div className="w-full aspect-square bg-[#455044] border border-black/50 rounded-3xl mb-6 flex flex-col justify-end pb-3 px-2">
          <div className="bg-gradient-to-b from-[#FFFFFF] to-[#FFFFFD] border border-[#7b8942] rounded-3xl py-3 px-1 mb-0">
